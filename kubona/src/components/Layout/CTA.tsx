...
export default function CTA() {
  ...
  return (
    <section className=" min-h-full my-20 flex items-center justify-center">
      <div className="bg-[url('/assets/saloes/cta.jpg')] container h-96 bg-cover bg-center text-white rounded-2xl overflow-hidden max-[645px]:rounded-none">
        <div className=" bg-[#000000bf] w-full h-full  px-20 py-20 flex flex-col items-start justify-center max-md:items-center max-md:text-center max-md:px-8 max-md:py-8 ">
